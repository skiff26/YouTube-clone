<template>
	<div :class="classes" tabindex="-1" @keydown.esc="close">
		...
		<div v-if="isOpen" class="relative bg-white w-full sm:w-2/3 xl:w-4/5 m-8 flex flex-col" style="max-height: calc(100vh - 64px);">
...
export default {
	...
	data(){
		return {
			isOpen: true,
			classes: ['fixed', 'inset-0', 'z-30', 'focus:outline-none', 'flex', 'justify-center', 'items-start', 'mx-auto'],
		}
	},
	methods: {
		close(){
