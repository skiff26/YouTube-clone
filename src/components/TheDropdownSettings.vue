  ...
  <div class="relative">
    ...
    <transition
      ...
      >
			...
			<component v-if="selectedMenu" :is="menu" :selected-options="selectedOptions" @close="closeMenu" @select-option="selectOption"/>	
...
export default {
  ...
  data(){
	return {
		...
		dropdownClasses: ['z-10', 'absolute', 'top-9', '-right-full', 'sm:right-0', 'bg-white', 'w-72', 'border', 'border-t-0', 'focus:outline-none']
	}
  },  
  computed: {
	menu(){
